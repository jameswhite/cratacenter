...
<p>For the serial port setup, I need:</p>
...
<p>I cabled the cisco rollover cables to the edge switches, and the null-modem cables to the NAS, and the consoles on the two APU4s. Then plugged the USB side into the 7 port USB switch, and used the last two ports to power the raspberry pi and the monitor from the Kano.me kit.</p><br>
